...
from app.models import Attendance, Attendance_Report, Session_Year, Staff,Staff_Notification,Staff_leave,Staff_feedback, Student, StudentResult, Subject
...
@login_required(login_url='/')
def STAFF_MARK_NOTIFICTAION_MARK_AS_DONE(request,status):
